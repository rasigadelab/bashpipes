/*
 * Feature processes for Bacteria Illumina Assembly/Annotation Pipeline
 *
 * Description:
 *   Defines functions to create one directory for each analyzed genomes and copy input FASTQ in genome directory.
 *
 * License:
 *   AGPL-3.0-only
 */
