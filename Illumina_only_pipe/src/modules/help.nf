/*
 * Help utilities for Bacteria Illumina Assembly/Annotation Pipeline
 *
 * Description:
...
def printHelp() {
  ...
  Usage
    nextflow -C nextflow.config run main.nf -params-file params_illumina_only.json -profile <profile> [options]

  Description:
    ${workflow.manifest.description ?: 'Illumina assembly/annotation pipeline for prokaryotic reads'}
