/*
 * Bacteria Illumina Assembly and Annotation Pipeline
 * 
 * Description:
 *   Nextflow pipeline for bacterial whole genome assembly/annotation (using only Illumina data).
 *
 * Author:
 ...
 *
 * Usage
 *   nextflow -C nextflow.config run main.nf -params-file params_illumina_only.json -with-trace -with-report --prefix run_illumina_only -profile standard
 */
