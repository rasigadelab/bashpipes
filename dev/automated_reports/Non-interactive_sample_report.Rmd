...
<!--
*******************************************************************
Title: Non-interactive_sample_report.Rmd
Description: Report at sample level, identifying ST, sequencing QC and resistome of the isolate.
...
```{r cleaning}
rm(beta_lactam, sample_id, params, global_theme, reports, mobtyper_reports)
```
