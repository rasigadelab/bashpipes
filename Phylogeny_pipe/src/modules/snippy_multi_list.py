...
def main(work_dir, samples_list, out_dir):
    ...
    for sample in samples_list:
        ...
        R1 = os.path.join(genomes_dir, sample, "trimmomatic", sample+"_R1_paired.trimmed.resync.fastq.gz")
        R2 = os.path.join(genomes_dir, sample, "trimmomatic", sample+"_R2_paired.trimmed.resync.fastq.gz")
