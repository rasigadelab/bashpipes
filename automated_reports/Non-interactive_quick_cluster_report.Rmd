...
subtitle: "GH Centre, HS Hépato-Gastro-Entérologie (Pavillon L RDC) UF21230, *Enterobacter cloacae* (`r params$replicon`)"
...
params:
  ...
  replicon: "Chromosome"
  env_samples: ""
  path_to_reports: "../Script_Tests/2024-01-25_clone_reports.Rdata"
  path_to_scan:  "../Script_Tests/2024-01-25_annotation_scan.Rdata"
output:
  pdf_document:
      toc: true
      toc_depth: 2
...
Ce rapport d'études de cluster étudie les isolats de l'espèce ___E. cloacae___ du HS d'hépato-gastro-entérologie (Pavillon L RDC) du GH Est.
...
} else if(params$species == "chromosome" & params$cluster_id == 50){
  species_in_title <- "A. faecalis"
} else if(params$species == "chromosome" & params$cluster_id == 48){
  species_in_title <- "B. fragilis"
} else if(params$cluster_id == 60){
