...
L'isolat `r params$sample_glims` est composé de `r nb_plasmid` plasmides. Voici le détail de la composition en gènes de résistance de chacun d'entre eux. 
...
for(plasmid in list_plasmids){
  plasmid_id1 <- sub("-+$", "\\1", plasmid) # unlist(strsplit(plasmid, "-", perl=TRUE))[1]
